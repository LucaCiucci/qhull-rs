    ...
    unsafe fn try_impl<'b>(
        ...
        if err_code == 0 {
            ...
            Err(QhError {
                kind,
                error_message: msg,
                face: Facet::from_ptr(qh, qh.tracefacet, qh.input_dim as _),
                ridge: Ridge::from_ptr(qh, qh.traceridge, qh.input_dim as _),
                vertex: Vertex::from_ptr(qh, qh.tracevertex, qh.input_dim as _),
            })
        }
    }
}
